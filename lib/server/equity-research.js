...
function publicMarketPriceContext(valuation, {
  ...
  const canonicalRecordsPresent = sourceRecordIsFreshAndOk(sourceRecordMap, "fmp:quote", {
    now,
...
const PUBLIC_SOURCE_ID_PATTERN = /^(?:fmp:(?:profile|quote|prices|analyst-estimates|key-metrics-ttm|ratios-ttm|shares-float|income:(?:annual|quarterly|ttm)|balance:(?:annual|quarterly|ttm)|cash-flow:(?:annual|quarterly|ttm))|sec:(?:submissions|companyfacts:(?:income|balance|cash-flow|reconciliation))|market:independent-close)$/;
