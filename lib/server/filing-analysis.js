...
import {hasNonLocatorDigits} from '../research/numeric-locators.mjs';

export const MODEL = 'openai/gpt-oss-120b';
export const VERSION = 'filing-analysis-groq-v11.4';
...
const hasQuantity=s=>hasNonLocatorDigits(s)||writtenQuantity.test(s);
