...
function buildOverlayPortfolioAnalytics(snapshot, holdings, sourceLabel) {
  ...
  return {
    analytics: {
      ...
      "Total P&L incl. realized/dividends": unrealizedPnlUsd,
      "Total return incl. dividends": unrealizedReturn,
