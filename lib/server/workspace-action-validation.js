...
export function errorResponse(error) {
  ...
  if (/Could not parse|No current price found|Please provide|Invalid|Unsupported tickers|overlapping history|rolling window|timed out|Unexpected phantom diversification failure/i.test(message)) {
