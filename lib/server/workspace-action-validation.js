...
export function errorResponse(error) {
  ...
  if (/Could not parse|No current price found|Please provide|Invalid/i.test(message)) {
...
export function parsePhantomDiversificationPayload(body) {
  ...
  if (payload.holdings.length > 24) {
    throw new RequestValidationError("holdings must contain 24 items or fewer.");
  }
