...
export function errorResponse(error) {
  ...
  if (/Could not parse|No current price found|Please provide|Invalid|Unsupported tickers|overlapping history|rolling window|timed out|Unexpected phantom diversification failure|At least 3|weights must sum|failed with exit code/i.test(message)) {
