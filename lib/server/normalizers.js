...
function getCanonicalContract(snapshot) {
  const contract = snapshot?.bls_state_v1;
    ...
    data_control: {
      ...
      notes: [
        ...
        contractStatus === "canonical_valid"
          ? "BLS State Contract v1 is active; canonical backend state is driving the risk and repair framework."
          : "Terminal is using legacy JS synthesis for parts of the BLS framework.",
      ],
    },
