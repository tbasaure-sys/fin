...
function buildBackupAdvice(snapshot) {
  ...
  return {
    ...
    sizeValue: 0,
    funding: "No change",
    conviction: `${defensiveTicker} is still the sleeve preserving room to act later.`,
    whyNow: `${defensiveTicker} is still the holding most likely to buy time if the market weakens again.`,
