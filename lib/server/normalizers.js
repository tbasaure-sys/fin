...
function buildPortfolioModule(snapshot, watchlistCount, sharedAlpha) {
  ...
  const annualReturnValue = analyticsSource === "holdings_proxy"
    ? numberOr(analytics["Unrealized Return"], analytics["Annual Return"], computedAnalytics.annualReturn)
    : numberOr(analytics["Annual Return"], analytics["Unrealized Return"], computedAnalytics.annualReturn);
  ...
  const sharpeRatioLabel = sharpeRatioValue !== null
    ...
    : holdingsSource.connected
      ? "History needed"
      : "Not enough history";
  const totalReturnValue = computedAnalytics.totalReturn !== null ? computedAnalytics.totalReturn : unrealizedReturnValue;
  const totalReturnLabel = totalReturnValue !== null ? formatSignedPct(totalReturnValue) : "Not enough history";
  const benchmarkReturnLabel = computedAnalytics.benchmarkReturn !== null
  ...
  return {
    ...
    analytics: {
      ...
      totalReturnLabel,
      benchmarkReturn: computedAnalytics.benchmarkReturn,
      benchmarkReturnLabel,
      excessReturn: computedAnalytics.excessReturn,
      excessReturnLabel: computedAnalytics.excessReturn !== null ? formatSignedPct(computedAnalytics.excessReturn) : "History needed",
