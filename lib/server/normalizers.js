...
function buildPortfolioModule(snapshot, watchlistCount, sharedAlpha) {
  ...
  const annualReturnValue = numberOr(analytics["Annual Return"], computedAnalytics.annualReturn);
  const annualVolatilityValue = numberOr(analytics["Annual Volatility"], computedAnalytics.annualVolatility);
  const sharpeRatioValue = numberOr(analytics["Sharpe Ratio"], computedAnalytics.sharpeRatio);
  ...
  return {
    ...
    analytics: {
      ...
      annualReturnLabel: formatMetricLabel(annualReturnValue, fmtPct),
      annualVolatility: annualVolatilityValue,
      annualVolatilityLabel: formatMetricLabel(annualVolatilityValue, fmtPct),
      sharpeRatio: sharpeRatioValue,
      sharpeRatioLabel: formatMetricLabel(sharpeRatioValue, (value) => formatNumberLike(value)),
      totalReturn: computedAnalytics.totalReturn,
      totalReturnLabel: formatMetricLabel(computedAnalytics.totalReturn, formatSignedPct),
      benchmarkReturn: computedAnalytics.benchmarkReturn,
      benchmarkReturnLabel: formatMetricLabel(computedAnalytics.benchmarkReturn, formatSignedPct),
      excessReturn: computedAnalytics.excessReturn,
      excessReturnLabel: formatMetricLabel(computedAnalytics.excessReturn, formatSignedPct),
      maxDrawdown: computedAnalytics.maxDrawdown,
      maxDrawdownLabel: formatMetricLabel(computedAnalytics.maxDrawdown, fmtPct),
      benchmarkSymbol,
