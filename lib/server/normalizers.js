...
function inferHoldingRole(holding) {
  ...
  if ([
    ...
    return {
      id: "ballast",
      label: "Ballast",
      description: "Absorbs pressure and keeps optionality alive when the frontier is narrow.",
      fragility: 0.12,
      recovery: 0.2,
      sponsorship: 0.3,
    };
  ...
  if (sector.includes("health") || sector.includes("consumer staples") || sector.includes("utilities")) {
    return {
      id: "stability",
      label: "Stability",
      description: "Carries the book through pressure without needing heroic market conditions.",
      fragility: 0.28,
      recovery: 0.38,
      sponsorship: 0.46,
    };
  ...
  if (sector.includes("technology") || sector.includes("communication")) {
    return {
      id: "compounder",
      label: "Compounder",
      description: "Helps the book earn upside when the structure heals instead of just bouncing.",
      fragility: 0.46,
      recovery: 0.74,
      sponsorship: 0.68,
    };
  ...
  if (sector.includes("industrial") || sector.includes("financial") || sector.includes("energy") || sector.includes("materials")) {
    return {
      id: "cyclical",
      label: "Cyclical",
      description: "Needs cleaner sponsorship, but can add recovery torque when conditions improve.",
      fragility: 0.64,
      recovery: 0.67,
      sponsorship: 0.58,
    };
  ...
  if (sector.includes("real estate") || sector.includes("biotech") || sector.includes("consumer discretionary") || sector.includes("unknown")) {
    return {
      id: "fragile",
      label: "Fragile",
      description: "Adds upside only if the rebound is real; otherwise it reloads fragility.",
      fragility: 0.78,
      recovery: 0.52,
      sponsorship: 0.42,
    };
  ...
  if (weightValue >= 0.08) {
    return {
      id: "core",
      label: "Core",
      description: "One of the positions carrying the current book whether you intend it or not.",
      fragility: 0.42,
      recovery: 0.58,
      sponsorship: 0.55,
    };
  ...
  return {
    id: "satellite",
    label: "Satellite",
    description: "A smaller sleeve that should justify its place through diversification or asymmetry.",
    fragility: 0.52,
    recovery: 0.5,
    sponsorship: 0.48,
  };
...
function buildCapitalTwin(portfolioModule, xray, frontier, stressMode, mandate, escrow) {
  ...
  return {
    ...
    subhead: "A live shadow book showing how the current portfolio behaves under the paths that matter.",
