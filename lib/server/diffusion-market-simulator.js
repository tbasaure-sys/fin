...
function buildDeploymentContract(requestPolicy, guidanceInfo) {
  ...
  return {
    ...
    endpointGate:
      ...
      "Endpoint serves the PIT FHS factor stress bank when portfolio coverage is sufficient; unconditional books remain diagnostic until train-only validation clears.",
