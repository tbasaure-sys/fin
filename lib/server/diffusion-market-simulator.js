...
export function buildDiffusionMarketSimulation(dashboard = {}, options = {}) {
  ...
  return {
    ...
    warnings: [
      ...
      "Live endpoint currently serves a calibrated JavaScript stress runtime aligned to the v8 baseline contract; the PyTorch checkpoint remains an offline challenger artifact.",
