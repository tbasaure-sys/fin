...
const CONCEPTS={
 ...
 netIncome:['NetIncomeLoss'],da:['DepreciationDepletionAndAmortization'],sbc:['ShareBasedCompensation'],
 receivablesChange:['IncreaseDecreaseInAccountsReceivable'],inventoryChange:['IncreaseDecreaseInInventories'],
...
const nonnegative=new Set(['revenue','capex','buybacks','dividends','sbc']);
