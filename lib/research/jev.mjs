...
export const JEV_RUBRIC = 'bls-evidence-v1';
...
export function questionsFor(kind, index) {
  ...
  if (kind === 'news') return {
    relevance: choice(at + 'How directly does the headline concern the target company?', { direct: 'Explicit company-specific event', indirect: 'Peer or sector context', unrelated: 'Other company or topic', unknown: 'Identity or relevance unclear' }),
