...
function buildPipelineDecision(compiled, monitor, extractedEvidence, driverGraph = null, equilibrium = null, forecast = null, valuationEnsemble = null, expectations = null) {
...
function buildPipelineMemo(compiled, monitor, decision, driverGraph = null, equilibrium = null, forecast = null, valuationEnsemble = null, expectations = null) {
...
export function runAuroraBeliefPipeline(input = {}, options = {}) {
  ...
  const decision = buildPipelineDecision(compiled, monitor, extractedEvidence, driverGraph, equilibrium, forecast, valuationEnsemble, expectations);
  ...
  return {
    ...
    beliefObject: compiled.beliefObject,
    monitor,
    memo: buildPipelineMemo(compiled, monitor, decision, driverGraph, equilibrium, forecast, valuationEnsemble, expectations),
  };
}
