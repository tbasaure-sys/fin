...
function buildPipelineDecision(compiled, monitor, extractedEvidence, driverGraph = null) {
...
function buildPipelineMemo(compiled, monitor, decision, driverGraph = null) {
...
export function runAuroraBeliefPipeline(input = {}, options = {}) {
  ...
  const decision = buildPipelineDecision(compiled, monitor, extractedEvidence, driverGraph);
  ...
  return {
    ...
    monitor,
    memo: buildPipelineMemo(compiled, monitor, decision, driverGraph),
  };
}
