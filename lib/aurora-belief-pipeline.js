...
function buildPipelineDecision(compiled, monitor, extractedEvidence, driverGraph = null, equilibrium = null, forecast = null) {
...
function buildPipelineMemo(compiled, monitor, decision, driverGraph = null, equilibrium = null, forecast = null) {
...
export function runAuroraBeliefPipeline(input = {}, options = {}) {
  ...
  const decision = buildPipelineDecision(compiled, monitor, extractedEvidence, driverGraph, equilibrium, forecast);
  ...
  return {
    ...
    monitor,
    memo: buildPipelineMemo(compiled, monitor, decision, driverGraph, equilibrium, forecast),
  };
}
