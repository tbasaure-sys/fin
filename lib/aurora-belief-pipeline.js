...
function buildPipelineDecision(compiled, monitor, extractedEvidence, driverGraph = null, equilibrium = null) {
...
function buildPipelineMemo(compiled, monitor, decision, driverGraph = null, equilibrium = null) {
...
export function runAuroraBeliefPipeline(input = {}, options = {}) {
  ...
  const decision = buildPipelineDecision(compiled, monitor, extractedEvidence, driverGraph, equilibrium);
  ...
  return {
    ...
    monitor,
    memo: buildPipelineMemo(compiled, monitor, decision, driverGraph, equilibrium),
  };
}
