...
function usage() {
  return [
    "Usage: node scripts/run_aurora_accounting_engine.mjs --input snapshot.json [--output accounting.json]",
    "",
    "Input accepts { company, financials, accountingPolicy, drivers }.",
  ].join("\n");
}
...
const result = buildAuroraAccountingEngine(payload, payload.options || {});
