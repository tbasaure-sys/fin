...
const TEXT_TRANSLATIONS = {
  ...
  "One private workspace": "Un workspace privado",
  ...
  "The native app uses the same account and the same workspace APIs as the website.": "La app nativa usa la misma cuenta y las mismas APIs del workspace que el sitio web.",
  "Your private workspace": "Tu workspace privado",
  ...
  "Creates your private workspace in one step.": "Crea tu workspace privado en un solo paso.",
  "or": "o",
  ...
  "to your workspace.": "a tu workspace.",
  "Recover access to your workspace.": "Recupera el acceso a tu workspace.",
  ...
  "This secure link lets you replace the old password and sign back into your workspace right away.": "Este enlace seguro te permite reemplazar la contraseña anterior y volver a entrar al workspace.",
  ...
  "3. No trading or execution": "3. Sin trading ni ejecución",
  "The workspace does not place trades, route orders, manage money, or execute transactions. Any staged action, memo, valuation, model, alert, or checklist is a research artifact only.": "El workspace no coloca trades, enruta órdenes, administra dinero ni ejecuta transacciones. Cualquier acción preparada, memo, valoración, modelo, alerta o checklist es solo un artefacto de investigación.",
  ...
  "Open the current memo, the valuation debate, and the sources without leaving the workspace.": "Abre el memo actual, el debate de valoración y las fuentes sin salir del workspace.",
  "Holdings": "Posiciones",
  "Update": "Actualizar",
  ...
  "Alerts": "Alertas",
  "Staged": "Preparadas",
  "Ask workspace": "Preguntar al workspace",
  "Glossary": "Glosario",
  "Guide": "Guía",
  "Terms": "Términos",
  ...
  "Saving...": "Guardando...",
  "This path updates the final position directly instead of trying to infer a trade note.": "Esta ruta actualiza la posición final directamente, sin intentar inferir una nota de trade.",
  ...
  "Stop": "Detener",
  "Send": "Enviar",
  "Answers are grounded in your workspace data but are not financial advice. Always verify before acting.": "Las respuestas se basan en los datos de tu workspace, pero no son asesoría financiera. Verifica siempre antes de actuar.",
  "Language": "Idioma",
};
...
const ATTRIBUTE_TRANSLATIONS = {
  ...
  "Run a fast memo and valuation pass": "Ejecutar memo y valoración rápida",
};
