...
const TEXT_TRANSLATIONS = {
  ...
  "No change needed while reserve use is unclear.": "Sin cambios mientras el uso de caja no esté claro.",
  ...
  "Wait for a cleaner state before spending optionality on new risk.": "Espera una señal más clara antes de sumar riesgo.",
