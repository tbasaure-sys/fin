...
const TEXT_TRANSLATIONS = {
  ...
  "Sign in once, then return to the same valuation OS, portfolio, research desk, and decision memory from web or mobile.": "Inicia sesión una vez y vuelve al mismo Valuation OS, portafolio, mesa de investigación y memoria de decisiones desde web o móvil.",
  ...
  "Your valuation workspace, holdings, research, and staged decisions all come back after login.": "Tu Valuation OS, posiciones, investigación y decisiones preparadas vuelven después de iniciar sesión.",
