...
const COPY = {
  es: {
    ...
    rows: [
      ...
      ["05", "Una tesis, dos explicaciones", "La tesis privada conserva una explicación principal y una alternativa. Cada eslabón vincula sus fuentes, incertidumbres y una comprobación que podría cambiar la lectura."],
      ["06", "Revisar sin borrar", "Los escenarios nacen de una revisión identificada. El historial conserva fuentes y motivos; una corrección técnica o una nueva lectura no se etiqueta como novedad económica ni como alpha."],
    ],
  ...
  en: {
    ...
    rows: [
      ...
      ["05", "One thesis, two explanations", "Your private thesis preserves a main explanation and an alternative. Each link connects sources, uncertainties and a check that could change the interpretation."],
      ["06", "Revise without erasing", "Scenarios branch from an identified revision. History retains sources and reasons; technical fixes and new readings do not establish economic novelty or alpha."],
    ],
